        ...
        <><div className="suspenseful-world1">
            ...
            <div className="suspenseful-world">
                ...
                <div className="text-content" data-aos="fade-right">
                    ...
                    <p>
                    With a career spanning over two decades, Siraj ul Haque has become a luminary in the world of Tv Drama industry. His directorial journey began in 1999, and since then, he has crafted compelling narratives that resonate with audiences on a profound level. From his early short film "Chandani," screened at the 3rd Eye Film Festival in San Francisco, to his acclaimed feature film "Moomal Rano," which earned accolades at international film festivals, Siraj's work captures the essence of human experiences and societal intricacies.
                    </p>
                    <p>
                    Siraj's dedication to authenticity and meticulous attention to detail have earned him critical acclaim and numerous awards, including the Accolade Global Film Festival and the Sindh Film Festival. His association with the films, such as "Silent Water" and "Trouble in Paradise," blend artistry and emotion, creating immersive worlds with intricate plots and unforgettable characters.
                    </p>
                    <p>
